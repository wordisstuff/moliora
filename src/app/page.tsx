...
export default function Home() {
    return (
        <div className="container mx-auto grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen  pb-20 gap-7 sm:p-20 font-[family-name:var(--font-geist-sans)]">
            <main
                id="top"
