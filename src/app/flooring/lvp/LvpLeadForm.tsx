...
export default function LvpLeadForm() {
  ...
  return <div className="space-y-5">
    ...
    <div className="flex items-center gap-3 py-1 text-[11px] font-bold uppercase tracking-[.22em] text-white/35">
      <span className="h-px flex-1 bg-white/10" />
      <span>or send a quick request</span>
      <span className="h-px flex-1 bg-white/10" />
    </div>
    ...
    <form onSubmit={e => { e.preventDefault(); submit(e.currentTarget); }} className="border border-white/10 bg-white/[0.03] p-5 shadow-2xl sm:p-7">
