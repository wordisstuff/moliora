    ...
    return (
        <form onSubmit={event => { event.preventDefault(); submit(event.currentTarget); }} className="border border-white/10 bg-white/[0.03] p-5 shadow-2xl sm:p-7">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
                ...
                <label className="block"><span className="mb-2 block text-sm font-medium">Current flooring *</span><select name="existingFlooring" required defaultValue="" className={selectClass}><option value="" disabled>Select current floor</option><option>Carpet</option><option>LVP or Laminate</option><option>Hardwood</option><option>Tile</option><option>Bare subfloor</option><option>Not sure</option></select><span className="mt-1 block text-xs leading-5 text-white/40">This means the flooring currently in the room, before the new LVP is installed.</span></label>
                ...
                <label className="block"><span className="mb-2 block text-sm font-medium">Who is supplying the new LVP material? *</span><select name="materialSupply" required defaultValue="" className={selectClass}><option value="" disabled>Select</option><option>Need Moliora to supply it</option><option>I already have flooring</option><option>Not sure</option></select></label>
            </div>
